...
public class Example {
    ...
    public static void main(String[] args) {
       ...
       //Aufgabe: Überprüfen, ob ein Schlüssel existiert
        ...
        //Flo hat eine Nachkorrektur erhalten. Ändern Sie seine Note von `3.4` auf `4.0`
        grades.put("Flo", 4.0);

        //Iterieren Sie über alle **Values** der Map und berechnen Sie die Durchschnittsnote des Kurses
        double sum = 0;
        ...
        //Geben Sie alle Studenten (Name und Note) aus, die eine Note besser oder gleich `4.0` haben.
        //Nutzen Sie dafür das `entrySet()`
        ...
        //Drucken Sie eine alphabetisch sortierte Liste aller Studenten,
        // die am Kurs teilgenommen haben (Hinweis: Nutzen Sie `keySet()`).
